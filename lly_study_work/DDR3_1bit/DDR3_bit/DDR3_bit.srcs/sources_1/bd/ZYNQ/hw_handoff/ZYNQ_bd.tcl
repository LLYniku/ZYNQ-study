...
proc create_root_design { parentCell } {
  ...
  set key_init [ create_bd_port -dir I -from 0 -to 0 key_init ]
  ...
  connect_bd_intf_net -intf_net myip_0_M00_AXI [get_bd_intf_pins axi_smc/S00_AXI] [get_bd_intf_pins myip_0/M00_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets myip_0_M00_AXI] [get_bd_intf_pins myip_0/M00_AXI] [get_bd_intf_pins system_ila_0/SLOT_0_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]

  # Create port connections
  connect_bd_net -net Op1_0_1 [get_bd_ports key_init] [get_bd_pins util_vector_logic_0/Op1]
  connect_bd_net -net myip_0_m00_axi_error [get_bd_ports error_flag] [get_bd_pins myip_0/m00_axi_error]
  connect_bd_net -net myip_0_m00_axi_txn_done [get_bd_ports compare_done] [get_bd_pins myip_0/m00_axi_txn_done]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_smc/aclk] [get_bd_pins myip_0/m00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk] [get_bd_pins system_ila_0/clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_smc/aresetn] [get_bd_pins myip_0/m00_axi_aresetn] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn] [get_bd_pins system_ila_0/resetn]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins myip_0/m00_axi_init_axi_txn] [get_bd_pins util_vector_logic_0/Res]

  # Create address segments
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces myip_0/M00_AXI] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
